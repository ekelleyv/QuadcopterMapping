...
#Adapted from https://github.com/mikehamer/ardrone_tutorials
...
from std_msgs.msg import Empty, UInt8       	 # for land/takeoff/emergency
...
class BasicCommands(object):
	...
	def SendToggle(self):
		...
		self.pubToggle.publish(UInt8(0))
